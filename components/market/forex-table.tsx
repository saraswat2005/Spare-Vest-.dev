...
export function ForexTable({ markets, onMarketClick }: ForexTableProps) {
  ...
  const SortButton = ({
    column,
    children,
  }: { column: "symbol" | "price" | "change" | "volume"; children: React.ReactNode }) => (
    <Button
      variant="ghost"
      size="sm"
          ...
          <TableHeader>
            <TableRow className="bg-gray-50 dark:bg-gray-800/50">
              <TableHead className="font-semibold">
                <SortButton column="symbol">Currency Pair</SortButton>
              </TableHead>
              <TableHead className="text-right font-semibold">
                <SortButton column="price">Rate</SortButton>
              </TableHead>
              <TableHead className="text-right font-semibold">
              ...
              >
                <TableCell>
                  <div className="flex items-center space-x-3">
                    {market.flag && <span className="text-2xl">{market.flag}</span>}
                    <div>
                      ...
                      {market.country && (
                        <div className="text-xs text-gray-500 dark:text-gray-500">{market.country}</div>
                      )}
                    </div>
                  </div>
                </TableCell>
